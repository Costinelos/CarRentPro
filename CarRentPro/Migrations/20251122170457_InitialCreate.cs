    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleStocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleStocks_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VehicleStocks_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleStocks_BranchId",
                table: "VehicleStocks",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleStocks_VehicleId",
                table: "VehicleStocks",
                column: "VehicleId");
        }
